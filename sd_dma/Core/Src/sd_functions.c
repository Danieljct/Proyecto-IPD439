...
//implementing txrxcomplete callback
...
{
  // Asegurarse de que no hay transferencia previa pendiente (ya manejado)
...
static void SPI_RxBytePtr(uint8_t *buff)
{
  ...
  {
    spiDmaTransferComplete=0;
    // La función HAL_SPI_TransmitReceive_DMA colocará el dato recibido en 'buff'
